...
export default function ClientSideECheck() {
 ...
 useEffect(() => {
  GetFireBase('training-resource').then((res) => {
   setFiles(res)
  })
 ...
 const handleAction = (data) => {
  ...
  if (data.id == "open_files") {
   ...
   $('#trainingPreviewModel').modal('show')
  }
 ...
 return (
  // <ProtectedLayout>
  <div>
   <div className="modal fade" id="trainingPreviewModel" tabIndex="-1" role="dialog" aria-labelledby="previewModelTitle" aria-hidden="true">
